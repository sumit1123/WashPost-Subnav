...
/**
 * Based on https://github.com/okcredit/OkLayoutInflater
 *
...
class OkLayoutInflater : LifecycleEventObserver {
    ...
    private suspend fun inflateView(
        ...
        Logger.e(
            TAG,
            "The background thread failed to inflate. Inflation falls back to the main thread. Error message=${ex.message}"
        )
