...
import static com.washingtonpost.android.volley.Response.*;
...
public class ImageLoader {
    ...
    private final GlobalImageListener globalImageListener;
     ...
     */
    public ImageLoader(RequestQueue queue, ImageCache imageCache, GlobalImageListener globalImageListener) {
        mRequestQueue = queue;
        mCache = imageCache;
     ...
     * @param requestUrl The URL of the image to be loaded.
     */
    public ImageContainer getInBackground(String requestUrl, final ImageListener listener) {
     ...
     * @param maxWidth The maximum width of the returned image.
     * @param maxHeight The maximum height of the returned image.
     * @param isOnMainThreadOnly Executing it on the main thread only
     * @return A container object that contains all of the properties of the request, as well as
     *     the currently available image (default if remote is not loaded).
     */
    public ImageContainer get(String requestUrl, ImageListener imageListener,
            int maxWidth, int maxHeight, boolean isOnMainThreadOnly) {
                        ...
                        for (ImageContainer container : bir.mContainers) {
                            ...
                            if (bir.getError() == null) {
                                ...
                                if (globalImageListener != null) {
                                    globalImageListener.onResponse(container.getBitmap(), container.getRequestUrl(), false);
                                }
                            } else {
                                container.mListener.onErrorResponse(bir.getError());
                                if (globalImageListener != null) {
                                    globalImageListener.onErrorResponse(bir.mRequest.getUrl(), bir.getError());
                                }
                            }
                        }
                    }
