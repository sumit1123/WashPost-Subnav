...
class ExternalStyleCarouselViewHolder(
    itemView: View,
    ...
    override fun bind(item: CarouselViewItem) {
        val viewItem: CarouselExternalViewItem = item as CarouselExternalViewItem
        cardView = itemView.findViewById(R.id.external_item_card)
        cardViewContent = itemView.findViewById(R.id.external_item_content)
        artView = itemView.findViewById(R.id.item_external_art)
        imageViewRef = WeakReference(artView)
        headlineView = itemView.findViewById(R.id.external_headline_title)
        kickerView = itemView.findViewById(R.id.external_kicker)
        ...
        cardViewContent?.apply {
            val cardBottomPadding = if (headlineView.isVisible || kickerView.isVisible || secondaryLabelView.isVisible) {
        ...
        itemView.findViewById<MaterialCardView>(R.id.external_item_card)
    ...
    private fun styleArtView(item: CarouselExternalViewItem) {
        artView.apply {
    ...
    private fun updateArtView(item: CarouselExternalViewItem) {
