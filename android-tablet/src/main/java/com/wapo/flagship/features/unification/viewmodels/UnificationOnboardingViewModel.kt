 ...
 */
@HiltViewModel
class UnificationOnboardingViewModel
    @Inject
    constructor(
        ...
        /**
         * Dispatches the value to the observer in this case UnificationOnboardingFragment.
         */
        ...
        fun initializeSettingSubAndAccountState() {
            if (PaywallService.getInstance() == null) {
                _remoteLogger.value =
                    "Unification Onboarding Screen : Aborted showing unification onboarding screen because PaywallService has not been initialized"
            ...
            when {
                ...
                loggedInUser.displayName != null ->
                    ...
                    _remoteLogger.value =
                        "Unification Onboarding Screen : Logged in user does not have email/display name to show on unification onboarding screen"
                    setAccountAndSubState(AccountSubState.GenericState)
                }
            }
        }
