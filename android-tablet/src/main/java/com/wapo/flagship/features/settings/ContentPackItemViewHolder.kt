...
/**
 * ViewHolder for the normal Content Pack view.
 * Only the first content pack is NOT this type. See [ContentPackItemLargeViewHolder].
 */
class ContentPackItemViewHolder(
    val binding: ContentPackBinding,
