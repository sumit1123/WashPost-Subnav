...
import com.wapo.flagship.features.print.AutoResetMode;
import com.washingtonpost.android.R;

/**
 * TouchZoomImageView is a pinch-to-zoom extension of {@link ImageView}, providing a smooth
 ...
 * visible window.
 */
public class TouchZoomImageView extends AppCompatImageView implements OnScaleGestureListener {
    ...
    private final GestureDetector.OnGestureListener gestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            if (listener != null) {
                listener.onPhotoTap(e.getX(), e.getY());
            }
    ...
    public void  setPhotoTapListener(OnPhotoTapListener context){
        this.listener = context;
    }

    public interface OnPhotoTapListener {
        void onPhotoTap(float xValue, float yValue);
    }
}
