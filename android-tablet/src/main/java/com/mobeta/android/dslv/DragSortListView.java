...
public class DragSortListView extends ListView {
    ...
    private void drawDivider(int expPosition, Canvas canvas) {
        ...
        // LogUtil.d("mobeta", "div="+divider+" divH="+dividerHeight);
        ...
        if (divider != null && dividerHeight != 0) {
            ...
            if (expItem != null) {
                ...
                // LogUtil.d("mobeta", "l="+l+" t="+t+" r="+r+" b="+b);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mFloatView != null) {
            ...
            canvas.save();
            // LogUtil.d("mobeta", "clip rect bounds: " + canvas.getClipBounds());
    ...
    private void printPosData() {
        Logger.d("mobeta", "mSrcPos=" + mSrcPos + " mFirstExpPos=" + mFirstExpPos + " mSecondExpPos="
                + mSecondExpPos);
    }
    ...
    private boolean updatePositions() {
        ...
        if (mAnimate) {
            ...
            // LogUtil.d("mobeta", "edgeTop="+edgeTop+" edgeBot="+edgeBottom);
    ...
    private void adjustOnReorder() {
        ...
        // LogUtil.d("mobeta", "first="+firstPos+" src="+mSrcPos);
        if (mSrcPos < firstPos) {
            ...
            // LogUtil.d("mobeta", "top="+top+" fvh="+mFloatViewHeight);
    ...
    private int getChildHeight(int position) {
        ...
        if (v != null) {
            ...
            if (childHeight != -1) {
                // LogUtil.d("mobeta", "found child height in cache!");
                return childHeight;
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // LogUtil.d("mobeta", "onMeasure called");
        if (mFloatView != null) {
    ...
    protected boolean onDragTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_CANCEL:
                ...
                break;
            case MotionEvent.ACTION_UP:
                // LogUtil.d("mobeta", "calling stopDrag from onDragTouchEvent");
                if (mDragState == DRAGGING) {
                    stopDrag(false);
                }
                doActionUpOrCancel();
    ...
    private void doDragFloatView(int movePos, View moveItem, boolean forceInvalidate) {
        ...
        if (updated) {
            ...
            // LogUtil.d("mobeta", "  adjust scroll="+scroll);
    ...
    private void updateFloatView() {
        ...
        // LogUtil.d("mobeta", "dragView top=" + (y - mDragDeltaY));
        // LogUtil.d("mobeta", "limit=" + limit);
        // LogUtil.d("mobeta", "mDragDeltaY=" + mDragDeltaY);
    ...
    private class DragScroller implements Runnable {
        ...
        public void run() {
            ...
            if (scrollDir == UP) {
                View v = getChildAt(0);
                // LogUtil.d("mobeta", "vtop="+v.getTop()+" padtop="+padTop);
                if (v == null) {
                    mScrolling = false;
                    return;
                } else {
            ...
            mPrevTime = mCurrTime;
            // LogUtil.d("mobeta", "  updated prevTime="+mPrevTime);
        ...
        public DragSortTracker() {
            ...
            if (!mFile.exists()) {
                try {
                    ...
                    Logger.e("mobeta", "Could not create dslv_state.txt");
                }
            }
