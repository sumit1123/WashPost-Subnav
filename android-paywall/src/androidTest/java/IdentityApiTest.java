...
public class IdentityApiTest {
    ...
    public void setUp() throws JSONException, IOException {
        ...
        AppContextUtils.INSTANCE.init(testContext, "appName");
    ...
    @Test
    public void testMigrateUserToAuth() throws InterruptedException {
        String loginId = "884F14D899172D84E0530100007F06CC";
        String publicKey = "";
        mockWebServer.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody("{\"token_type\":\"bearer\", \"access_token\":\"access_token\", \"expires_at\":1000, \"refresh_token\":\"refresh_token\", \"id_token\":\"id_token\", \"scope\":\"scope\"}")
        );
        URL url = mockWebServer.url("/test").url();
        TokenResponse tokenResponse = apiService.migrateUserToAuth(loginId, publicKey, CLIENT_ID, url.toString());
        assertNotNull(tokenResponse);
        assertNotNull(tokenResponse.accessToken);
        assertNotNull(tokenResponse.accessTokenExpirationTime);
