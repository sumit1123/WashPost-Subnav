...
public class AuthStateManager {
    ...
    public void clearState() {
        ...
        PaywallService.getConnector().logD(new EventLog.Builder().setMessage("Auth State cleared"));
    }
        ...
        try {
            ...
            try {
                ...
                PaywallService.getConnector().logE(new EventLog.Builder()
                        .setMessage("Failed to deserialize stored auth state - discarding")
                        .setErrorMessage(ex.getMessage()));
                Logger.e(TAG, "Failed to deserialize stored auth state - discarding");
                return new AuthState();
            }
        } finally {
            mPrefsLock.unlock();
