...
import com.washingtonpost.android.paywall.databinding.ListCheckTextBinding
import com.washingtonpost.android.paywall.util.*

class ListCheckTextView : FrameLayout {
    ...
    private val binding = ListCheckTextBinding.inflate(LayoutInflater.from(context), this, true)
